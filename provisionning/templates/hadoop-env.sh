...
export HADOOP_HOME={{ install_hadoop_dir }}/{{ install_hadoop_file }}
...
export HADOOP_SSH_OPTS="-o BatchMode=yes -o StrictHostKeyChecking=no -o ConnectTimeout=60s"
...
# helper scripts # such as datanodes.sh, start-dfs.sh, etc.
# export HADOOP_WORKERS="${HADOOP_CONF_DIR}/datanodes"
